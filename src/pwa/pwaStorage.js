const INSTALL_STATE_KEY = 'delivery_pwa_install_state_v1';
const TUTORIAL_SEEN_KEY = 'delivery_pwa_shortcuts_tutorial_v1';
const SESSION_COUNTED_KEY = 'delivery_pwa_session_counted';
